    ...
    <Layout title="Settings">
      <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          {/* Tabs Sidebar */}
          <div 
            className={`lg:w-64 fixed inset-y-0 left-0 z-50 bg-background lg:bg-transparent transition-transform transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:block w-64`}
          >
                  ...
                  {tabs.map((tab) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          setActiveTab(tab.id);
                          setIsSidebarOpen(false); // Close sidebar on tab click in mobile
                        }}
